/*********************************************************************************************************//**
 * @file    USBD/STD_GK/Src_IAP/iap_ht32_usbd_descriptor.c
 * @version V1.04
 * @date    11/22/2012
...
#define DESC_IDPRODUCT            (0x8010)
#define DESC_BCDDEVICE            (0x0100)
#define DESC_IMANUFACTURE         (0)
#define DESC_IPRODUCT             (0)
...
#define DESC_NUM_STRING           (1 + DESC_IMANUFACTURE + DESC_IPRODUCT + DESC_ISERIALNUM)
...
#define DESC_BMATTR_SELF_POWER        (1)
...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  0x01,                       // bNumberInterface    1 Number of interfaces supported by this configuration
  ...
  DESC_H2B(0x0111),           // bcdHID              2 HID Specification Release Number
