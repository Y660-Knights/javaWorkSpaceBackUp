;********************************************************************************
;* @file      startup_ht32f175x_275x.s
;* @version   V1.00
;* @date      12/05/2012
;* @brief     CMSIS Cortex-M3 Core Device Startup File for the
;*            Holtek HT32F175x/275x Device Series
;*
;* @note      Copyright (C) 2011 Holtek Semiconductor Inc. All rights reserved.
;*
...
__Vectors           DCD  __initial_sp                       ; Top address of Stack
                    ...
                    DCD  HardFault_Handler                  ; Memory Management Fault Handler
                    ...
                    AREA    |.ARM.__AT_0x0000003C|, CODE, READONLY
                    IMPORT  SysTick_Handler
                    DCD     SysTick_Handler

                    AREA    |.ARM.__AT_0x000000E4|, CODE, READONLY
                    DCD     BFTM0_IRQHandler
                    DCD     BFTM1_IRQHandler
                    DCD     I2C0_IRQHandler
                    DCD     I2C1_IRQHandler
...
Reset_Handler       PROC
                    ...
                    IMPORT  WDT_Configuration
                    IMPORT  SystemInit
                    IMPORT  __main
                    LDR     R0, =WDT_Configuration
                    BLX     R0
                    LDR     R0, =SystemInit
                    BLX     R0
                    LDR     R0, =__main
