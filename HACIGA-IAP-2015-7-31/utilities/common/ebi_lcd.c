...
/* RESET LCD                                                                                              */
	...
	EBI_LCD->EBI_LCD_REG = 0xAE;  // 
	
	EBI_LCD->EBI_LCD_REG = 0x00;  /*  BT & VC Setting      */
	EBI_LCD->EBI_LCD_REG = 0x10;  // DC1.DC0 Setting   
	
	/*----------------------------*/
	EBI_LCD->EBI_LCD_REG = 0x00;  //   
	/*----------------------------*/
	EBI_LCD->EBI_LCD_REG = 0xB0;  //

	EBI_LCD->EBI_LCD_REG = 0x81;  //
	EBI_LCD->EBI_LCD_REG = 0xFF;  //invrsion control

	EBI_LCD->EBI_LCD_REG = 0xA1;  // RM.DM Setting      
	
	EBI_LCD->EBI_LCD_REG = 0xA6;  //Entry Mode     
	
	EBI_LCD->EBI_LCD_REG = 0xA8;  //  Enter ENG , must be set before gamma setting          
	EBI_LCD->EBI_LCD_REG = 0x1F;  //Open gamma function , must be set before gamma setting        
		
	EBI_LCD->EBI_LCD_REG = 0xC8;  //Open gamma function , must be set before gamma setting        
	
	EBI_LCD->EBI_LCD_REG = 0xD3;  //    		
	EBI_LCD->EBI_LCD_REG = 0x00;  //    
	
	EBI_LCD->EBI_LCD_REG = 0xD5;  //  Exit ENG , must be set before gamma setting            	
	EBI_LCD->EBI_LCD_REG = 0x80;  //Gamma setting     

	EBI_LCD->EBI_LCD_REG = 0xD9;  //  Color filter setting     	EBI_LCD->EBI_LCD_RAM = 0x09;
	EBI_LCD->EBI_LCD_REG = 0x04;  //    interface setting       

	EBI_LCD->EBI_LCD_REG = 0xDA; 
	EBI_LCD->EBI_LCD_REG = 0x00; 
	EBI_LCD->EBI_LCD_REG = 0x8D;  // Exit sleep mode      
	EBI_LCD->EBI_LCD_REG = 0x14; // Display on  }     
 	EBI_LCD->EBI_LCD_REG = 0xAF; // Display on  }     
	LCD_Clear(Black);
